...
_Last updated: 2026-06-25. This document describes what's actually built and wired right now — not the plan, the live state. Re-generate/update it whenever a major change lands._
...
## 5.7 Real type filters + searchable onboarding pickers (latest round)
